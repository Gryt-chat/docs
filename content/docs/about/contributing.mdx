...
The marketing site and blog live in `packages/site`. Blog posts are MDX files in `content/blog/` — see the [Site docs](/docs/about/blog) for the full writing guide.
