...
The marketing site and blog live in `packages/site` — [how it is built](/docs/about/website). Blog posts are MDX files in `content/blog/`, and [Writing blog posts](/docs/about/blog) is the full guide.
...
- AI-assisted code is disclosed (see the [AI policy](/docs/about/ai))

## License

Contributions are licensed under the [AGPL-3.0](/docs/about/licensing). By submitting a pull request, you agree that your contributions will be licensed under the same terms.
