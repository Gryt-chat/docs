...
sounds like too much, you probably want [a bot](/docs/build/bots) instead — a bot talks
...
This page teaches the shape. [The server plugin API](/docs/build/server-plugin-api) is
...
It needs `messaging`, and it's [its own page](/docs/build/plugin-pairs).
...
A [client addon](/docs/build/addons) is a theme or a plugin somebody installs
