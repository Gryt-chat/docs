...
**Drawing things doesn't.** A plugin can't add a button or change how a message
looks, because it isn't on the page. If that's what you wanted, Gryt doesn't do
it — and the reason is the section below.
