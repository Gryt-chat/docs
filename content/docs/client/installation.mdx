...
| **Linux** | [Snap Store](https://snapcraft.io/gryt-chat) · [Flathub](https://flathub.org/apps/com.gryt.Chat) · [AUR](https://aur.archlinux.org/packages/gryt-chat-bin) · [GitHub Releases](https://github.com/Gryt-chat/gryt/releases/latest) |
...
Install from [Flathub](https://flathub.org/apps/com.gryt.Chat):

```bash
flatpak install flathub com.gryt.Chat
...
```bash
chmod +x Gryt-Chat-*-linux-x86_64.AppImage
./Gryt-Chat-*-linux-x86_64.AppImage
```
...
# Flatpak
flatpak uninstall com.gryt.Chat
