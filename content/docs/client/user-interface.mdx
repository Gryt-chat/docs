...
See the [Accessibility guide](/docs/guide/accessibility) for our full commitment and roadmap toward a 100% accessible platform.
...
Gryt uses [Atkinson Hyperlegible Next](https://brailleinstitute.org/freefont) as its primary typeface and **Atkinson Hyperlegible Mono** for all monospaced text. Created by the Braille Institute of America, these fonts maximize character differentiation for users with low vision while looking great for everyone. See the [Accessibility](/docs/guide/accessibility) page for more on why we chose this font.
