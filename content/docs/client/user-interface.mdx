...
There's no theme provider component wrapping the tree. The appearance class goes
...
every property is removed before the next theme's are applied. A theme isn't
