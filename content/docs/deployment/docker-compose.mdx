...
You _can_ self-host your own Keycloak using the [provided configuration](/docs/guide/self-hosted-oidc), but that means your users will have separate accounts that don't work on other Gryt servers (no cross-server identity).
</Callout>
