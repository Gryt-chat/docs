...
SFU_PORT=5005
SFU_WS_HOST=ws://127.0.0.1:5005/ws
...
SFU_WS_HOST=ws://your-public-ip:5005/ws
```
...
| `SFU_WS_HOST` | `ws://127.0.0.1:5005/ws` | SFU WebSocket URL (used by the server internally) |
...
| `IDENTITY_MODE` | `builtin` | Authentication mode (`builtin` for self-hosted) |
