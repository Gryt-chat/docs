...
You may use AI assistance on documentation, the site, interface code, and tooling — but you have to say so. Tick the AI-assisted box in the pull request template if any part of your patch was AI-generated.

Gryt's core is different. The SFU, authentication and identity code, the image worker, and the data layer are hand-written, and contributions to them are expected to be too. See the [AI policy](/docs/guide/ai) for the full list of paths and the reasoning.
...
- AI-assisted code is disclosed, and stays out of core paths (see the [AI policy](/docs/guide/ai))
