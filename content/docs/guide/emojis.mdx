...
All raster images are resized to **128 pixels tall** (aspect ratio preserved, no enlargement). The maximum file size per image is configurable per server (default **5 MB**).
