...
Commits made with AI assistance keep their `Co-Authored-By` trailer, and the review-required paths have public PR history as well, so you can verify both in the git history. See the [AI policy](/docs/guide/ai) for the exact paths and the rules for contributors.
