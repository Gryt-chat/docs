...
**Server:** Node.js 22.13+ (npm or yarn) — the SQLite support built into Node arrived in that release, and 22.12 is not enough. Go 1.21+ for the SFU. Docker 20.10+ for containerized deployment.
...
that is `GRYT_IDENTITY_TIERS`, and the two do not interact.
