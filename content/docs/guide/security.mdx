...
Deliberate key rotation is not supported yet: rolling a server's key today looks the same
as an impersonation attempt and has to be unblocked by hand on each client.
