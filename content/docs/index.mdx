...
- **Accessibility-first** — From the [Atkinson Hyperlegible](/docs/use/accessibility) typeface to keyboard navigation and screen reader support. We’re working toward full accessibility across the platform.
...
<Cards>
  ...
  <Card
    ...
    description="One command installs the terminal manager, one more builds a server with working voice"
    href="/docs/host/cli"
  />
  <Card
    title="Every way to deploy"
    description="Docker Compose, Windows without Docker, tunnels, Kubernetes, or from the desktop app"
    href="/docs/host"
  />
  <Card
    title="Why Gryt?"
    description="Philosophy, trust boundaries, and a simple overview you can share"
    href="/docs/about/why-gryt"
  />
  <Card
