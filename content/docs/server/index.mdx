...
# Maintenance switch. Set to disabled to reject every join without stopping the server.
...
`GRYT_AUTH_MODE` doubles as the maintenance switch. Set it to `disabled` to
