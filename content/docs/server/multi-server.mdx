---
title: Multi-Server
description: Server switching and room isolation
icon: Server
---
...
```mermaid
graph TD
  A["Server A\nRoom: tech_1 · Users: 5"] --> Client
  B["Server B\nRoom: game_1 · Users: 12"] --> Client
  C["Server C\nRoom: music_1 · Users: 3"] --> Client
  Client["Web Client\nMulti-Server Management\nState Sync · Connection Pool"]
```
