...
- On Linux with avahi-daemon (default on Debian/Ubuntu), it writes a service file to `/etc/avahi/services/` — this is the most reliable method
...
- When a server shuts down, it removes the service
