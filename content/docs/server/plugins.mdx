...
<Callout>
Right now this arrives with the rest of the server details, which means somebody
sees it just after joining rather than before. Showing it before is worth doing
and isn't done yet.
</Callout>
