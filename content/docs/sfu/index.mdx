...
The default is 3478 — unprivileged, and already open on hosts that run STUN.
Production Gryt uses 443, which almost nothing blocks, at the cost of a
privileged bind and a clash with anything already serving HTTPS.
