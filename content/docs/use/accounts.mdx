...
| New device | a new identity, unless you [authorise the device](/docs/host/identity#authorising-a-device-instead-of-moving-your-identity-to-it) | sign in |
...
[keeps the membership you already have](/docs/host/identity) — your roles and
...
[Server → Identity](/docs/host/identity).
