...
See the [Build from Source](/docs/about/build-the-client) guide to compile the client yourself.

Once it is installed, [Updates](/docs/use/updates) covers how new versions arrive and how to change the channel.

## Troubleshooting

See [Troubleshooting](/docs/use/troubleshooting) for common installation issues, including OS security warnings and update problems.
